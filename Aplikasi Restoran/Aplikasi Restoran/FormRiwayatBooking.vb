...
Public Class FormRiwayatBooking
    Public Sub koneksi()
    ...
    End Sub
    Private Sub FormRiwayatBooking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call layarpenuh()
        Call koneksi()
        Call TampilGrid()
    End Sub
    ...
    Sub TampilGrid()
        DA = New SqlDataAdapter("select * from tbl_databooking", CONN)
        DS = New DataSet
        DA.Fill(DS)
